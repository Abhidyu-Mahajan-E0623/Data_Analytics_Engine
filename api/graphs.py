...
def anomaly_node(state: AnomalyState) -> dict[str, Any]:
    ...
    logger.info("[anomaly] ▶ Anomaly node started", extra={"log_module": "anomaly", "step": "start"})
    try:
        logger.info("[anomaly] Step 1: Loading settings", extra={"log_module": "anomaly", "step": "load_settings"})
        ...
        logger.info(
            ...
            run_id, schema,
            extra={"log_module": "anomaly", "step": "run_pipeline", "run_id": run_id},
        )
        ...
        logger.info(
            ...
            extra={"log_module": "anomaly", "step": "read_report", "run_id": run_id},
        )
        ...
        logger.info(
            ...
            outcome.total_anomalies,
            extra={"log_module": "anomaly", "step": "done", "run_id": run_id},
        )
        return {
        ...
        logger.exception("[anomaly] ✘ Anomaly node failed: %s", exc, extra={"log_module": "anomaly", "step": "error"})
...
def hypothesis_node(state: HypothesisState) -> dict[str, Any]:
    ...
    """
    logger = logging.getLogger("schema_maker.graph")
    logger.info("[hypothesis] ▶ Hypothesis node started", extra={"log_module": "hypothesis", "step": "start"})
    try:
        logger.info("[hypothesis] Step 1: Loading settings", extra={"log_module": "hypothesis", "step": "load_settings"})
        settings = load_settings_or_raise()
        ...
        logger.info(
            ...
            extra={"log_module": "hypothesis", "step": "init_clients", "run_id": run_id},
        )
        ...
        logger.info(
            ...
            extra={"log_module": "hypothesis", "step": "run_pipeline", "run_id": run_id},
        )
        ...
        logger.info(
            ...
            extra={"log_module": "hypothesis", "step": "read_output", "run_id": run_id},
        )
        ...
        logger.info(
            ...
            outcome.valid_count, outcome.invalid_count,
            extra={"log_module": "hypothesis", "step": "done", "run_id": run_id},
        )
        return {
            "run_id": outcome.run_id,
        ...
        logger.exception("[hypothesis] ✘ Hypothesis node failed: %s", exc, extra={"log_module": "hypothesis", "step": "error"})
        return {"error": str(exc)}
...
def insight_node(state: InsightState) -> dict[str, Any]:
    ...
    logger = logging.getLogger("schema_maker.graph")
    logger.info("[insight] ▶ Insight node started", extra={"log_module": "insight", "step": "start"})
    try:
        logger.info("[insight] Step 1: Loading settings", extra={"log_module": "insight", "step": "load_settings"})
        settings = load_settings_or_raise()
        ...
        if not run_id:
            logger.warning("[insight] No run_id provided and no latest run found", extra={"log_module": "insight", "step": "no_run_id"})
        ...
        if not hypothesis_ids:
            logger.info("[insight] Step 2: No hypothesis IDs provided — listing all for run %s", run_id, extra={"log_module": "insight", "step": "list_hypotheses"})
        ...
        logger.info(
            ...
            extra={"log_module": "insight", "step": "run_pipeline", "run_id": run_id},
        )
        pipe_logger = configure_logging(run_id=run_id)
        ...
        logger.info(
            ...
            extra={"log_module": "insight", "step": "read_report", "run_id": run_id},
        )
        ...
        logger.info(
            ...
            result.insight_count,
            extra={"log_module": "insight", "step": "done", "run_id": run_id},
        )
        return {
        ...
        logger.exception("[insight] ✘ Insight node failed: %s", exc, extra={"log_module": "insight", "step": "error"})
        return {"error": str(exc)}
